          ...
          <>
            <div className="bg-white border border-slate-150 rounded-2xl p-5 shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-slate-600">Total Mentors</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-150 rounded-2xl p-5 shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-slate-600">Active Mentors</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-150 rounded-2xl p-5 shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-slate-600">Inactive Mentors</p>
              </div>
            </div>
          </>
        )}
