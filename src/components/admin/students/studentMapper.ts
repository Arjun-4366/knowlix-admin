...
export const mapApiStudentToStudent = (student: IStudent): Student => ({
  ...
  subjectTutor: student.tutors?.[0]?.name || student.assignedTutorId || "Not assigned",
  mentorSalesBro: student.mentorName || student.mentor?.name || student.mentorId || "Not assigned",
