  ...
  return (
    <div className="space-y-6 w-full pb-10">
      <DashboardHeader
        ...
        description="View academy updates and post announcements for your assigned students."
      />
            ...
            <form onSubmit={handleAddNotice} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-1 space-y-1">
                  ...
                  <Input
                    ...
                    placeholder="e.g. Schedule Update / Homework Reminder"
              ...
              <div className="space-y-1">
                ...
                <Textarea
                  ...
                  placeholder="Type the notice announcement content here..."
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredNotices.length > 0 ? (
          filteredNotices.map((notice) => {
            ...
            // Only allow tutors to delete their own notices
            const isAuthor = notice.authorName === "Dr. Ramesh Prasad";
                ...
                <div className="px-6 py-4 bg-slate-50/50 border-t border-slate-100 rounded-b-2xl flex items-center justify-between text-[10px] font-semibold text-slate-450">
                  <div className="flex items-center gap-1.5 font-bold">
                    ...
                    <span className="truncate max-w-[125px]">
                      {notice.authorName} {isAuthor && "(You)"}
                    </span>
                  </div>
