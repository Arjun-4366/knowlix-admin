    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-slate-50 flex items-center justify-between bg-slate-50/20">
        <div>
          ...
          <p className="text-xs text-slate-450 mt-0.5">Average score and assigned tutor per curriculum block</p>
        </div>
            ...
            <div key={subj.subject} className="space-y-2">
              <div className="flex justify-between items-baseline">
                <div className="space-y-0.5">
                  ...
                  <p className="text-[10px] text-slate-400 font-semibold">Tutor: {subj.tutor}</p>
                </div>
