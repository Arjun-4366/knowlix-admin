        ...
        <TabsContent value="assignments">
          <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <Table className="table-fixed w-full min-w-[580px]">
                ...
                <TableBody className="divide-y divide-slate-50">
                  {!isLoadingAsg && assignments.length > 0 && assignments.map((asg) => {
            ...
            {/* Empty/loading states outside scroll area — centers on any screen width */}
            {isLoadingAsg && (
              <div className="flex justify-center items-center gap-2 py-12 text-xs text-slate-600">
            ...
            {!isLoadingAsg && assignments.length === 0 && (
          ...
          <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <Table className="table-fixed w-full min-w-[580px]">
                ...
                <TableBody className="divide-y divide-slate-50">
                  {submissionsHistory.length > 0 && submissionsHistory.map((sub) => (
